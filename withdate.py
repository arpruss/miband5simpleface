...
bigDigit = Digits(color = (255,255,255,255), size = (60,84), file = "heavy%01d.png", index="bigDigits")
...
dateDigit = Digits(color = (0,255,255,255), size = (25,25), file = "bold%01d.png", index="dateDigits")
battery = Battery(size=(128,4), backColor=(32,32,32,255), fullColor = (0,255,0,255), emptyColor = (128,128,0,255), index="battery")
